...
<section class="hero-section text-white py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="display-4 fw-bold mb-3">Expert Shoe Repair & Leather Craft</h1>
                <p class="lead mb-4">Bring new life to your favorite footwear with MR.FREDDIE's professional repair services.</p>
                <a href="register.php" class="btn btn-primary btn-lg">Get Started</a>
            </div>
            <div class="col-lg-6">
                <img src="assets/images/mr-freddie-bg.jpg" alt="Shoe Repair" class="img-fluid rounded shadow">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container text-center">
        <h2 class="mb-4">Ready to give your shoes a new life?</h2>
