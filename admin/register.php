...
if ($admin_count > 0 && (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'admin')) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO users (username, password, first_name, middle_name, last_name, age, email, phone_number, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'admin')");
...
<div class="auth-container">
    <div class="auth-logo">
        ...
        <h4 class="mt-2">Register New Admin</h4>
    </div>
